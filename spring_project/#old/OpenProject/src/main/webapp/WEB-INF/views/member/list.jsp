...
<body>
	...
	<div id="content">
		...
		<form>
			...
			</select> 검색 키워드<input type="text" name="keyword"> <input type="submit" value="검색">
		</form>
		<hr>
		...
		<table class="border">
			...
			<c:forEach items="${memberList}" var="member">
				<tr>
					...
					<td><a class="border" href="edit?idx=${member.idx}">수정</a> <a class="border"
						href="delete?idx=${member.idx}"
					>삭제</a></td>
				</tr>
			</c:forEach>
		</table>
