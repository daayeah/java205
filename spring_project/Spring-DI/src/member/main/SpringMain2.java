...
public class SpringMain2 {
	...
	public static void main(String[] args) {
		...
		// MemberRegService 객체를 컨테이너로부터 받음 ==
		...
		ChangePasswordService passwordService1 = ctx.getBean("changePwService",
				ChangePasswordService.class);
		ChangePasswordService passwordService2 = ctx.getBean("changePwService",
				ChangePasswordService.class);

		System.out.println(
				"passwordService1==passwordService2 : " + (passwordService1 == passwordService2));
