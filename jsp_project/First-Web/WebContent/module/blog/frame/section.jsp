...
<section>
	<article class="border_bottom_a margin_bottom_20">
		...
		<p class="post_content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque
			...
			sagittis porta augue et lacinia. Nam nulla odio, scelerisque vel risus ut, efficitur iaculis
			turpis. Duis id congue felis. Etiam ut porta elit. Vestibulum mi ex, imperdiet in bibendum ac,
			hendrerit quis purus. Maecenas fringilla pulvinar enim vitae congue. Ut eget nisi sodales, luctus
			dui vitae, tempus nisl. Cras nec neque consequat, commodo ligula in, viverra mauris. Integer
			lacinia commodo interdum.</p>
	</article>
	<article class="border_bottom_a margin_bottom_20">
		<h1 class="title">미니언즈 귀여운 매력에 바나나</h1>
		<p class="date">2021.07.02</p>
